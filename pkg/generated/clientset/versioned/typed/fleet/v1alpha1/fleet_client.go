...
// FleetV1alpha1Client is used to interact with features provided by the fleet.crd.tess.io group.
type FleetV1alpha1Client struct {
	restClient rest.Interface
}

func (c *FleetV1alpha1Client) Releases(namespace string) ReleaseInterface {
...
// NewForConfigAndClient creates a new FleetV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*FleetV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
