...
var releasesResource = schema.GroupVersionResource{Group: "fleet.crd.tess.io", Version: "v1alpha1", Resource: "releases"}

var releasesKind = schema.GroupVersionKind{Group: "fleet.crd.tess.io", Version: "v1alpha1", Kind: "Release"}
...
func (c *FakeReleases) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(releasesResource, c.ns, name, opts), &v1alpha1.Release{})
