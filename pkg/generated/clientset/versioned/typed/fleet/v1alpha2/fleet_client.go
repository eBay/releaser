...
func (c *FleetV1alpha2Client) ReleaseCalendars(namespace string) ReleaseCalendarInterface {
	return newReleaseCalendars(c, namespace)
}

func (c *FleetV1alpha2Client) ReleaseEvents(namespace string) ReleaseEventInterface {
	return newReleaseEvents(c, namespace)
}

// NewForConfig creates a new FleetV1alpha2Client for the given config.
...
// NewForConfigAndClient creates a new FleetV1alpha2Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*FleetV1alpha2Client, error) {
	...
	return &FleetV1alpha2Client{client}, nil
}

// NewForConfigOrDie creates a new FleetV1alpha2Client for the given config and
...
func New(c rest.Interface) *FleetV1alpha2Client {
	return &FleetV1alpha2Client{c}
}
