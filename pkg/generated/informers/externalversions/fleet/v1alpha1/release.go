...
import (
	...
	v1alpha1 "github.com/ebay/releaser/pkg/generated/listers/fleet/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FleetV1alpha1().Releases(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FleetV1alpha1().Releases(namespace).Watch(context.TODO(), options)
			},
		},
		&fleetv1alpha1.Release{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *releaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&fleetv1alpha1.Release{}, f.defaultInformer)
}
